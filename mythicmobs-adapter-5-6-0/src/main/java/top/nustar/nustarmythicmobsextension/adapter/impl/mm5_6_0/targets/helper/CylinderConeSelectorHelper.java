...
package top.nustar.nustarmythicmobsextension.adapter.impl.mm5_6_0.targets.helper;

import io.lumine.mythic.api.config.MythicLineConfig;
import io.lumine.mythic.core.skills.SkillExecutor;
import team.idealstate.sugar.next.context.annotation.component.Component;
import top.nustar.nustarmythicmobsextension.adapter.impl.NuStarTargerSelector;
import top.nustar.nustarmythicmobsextension.adapter.impl.mm5_6_0.targets.CylinderConeSelector;
...
public class CylinderConeSelectorHelper implements TargetSelectorHelperService {
    @Override
    public NuStarTargerSelector findSelector(Object... objects) {
        return new CylinderConeSelector((SkillExecutor) objects[0], (MythicLineConfig) objects[1]);
    }

    @Override
    public TargetSelectorType getType() {
        return TargetSelectorType.CYLINDER_CONE;
    }
}
