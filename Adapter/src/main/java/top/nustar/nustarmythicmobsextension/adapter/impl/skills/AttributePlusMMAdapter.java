...
public class AttributePlusMMAdapter {
    ...
    public AttributePlusMMAdapter(PlaceholderStringHelper<?> placeholderStringHelper, MythicLineConfigAdapter<?> mlc, MainConfiguration mainConfiguration) {
    ...
    public boolean castAtEntity(SkillMetadataAdapter<?> skillMetadata, AbstractEntityAdapter<?> abstractEntity) {
        try {
            ...
            if (clear) {
                ...
                AttributeAPI.addSourceAttribute(newData, "APMM_WhiteList", AttributeUtils.getWhiteAttributeList(data, mainConfiguration.getWhiteAttrList()));
