...
import top.nustar.nustarmythicmobsextension.adapter.impl.mm_4_9_0.targets.CylinderConeSelector;
...
public class CylinderConeSelectorHelper implements TargetSelectorHelperService {
    ...
    public NuStarTargerSelector findSelector(Object... objects) {
        return new CylinderConeSelector((MythicLineConfig) objects[0]);
    }
