...
public interface TargetSelectorHelperService {
    ...
    default TargetSelectorType findSelectorTypeFromService(TargetSelectorHelperService targetSelectorHelperService) {
        SupportTargetSelectorType supportTargetSelectorType =
                targetSelectorHelperService.getClass().getAnnotation(SupportTargetSelectorType.class);
        return supportTargetSelectorType.type();
    }

    default MythicMobsVersion findMythicMobsVersionFromService(
            TargetSelectorHelperService targetSelectorHelperService) {
        SupportTargetSelectorType supportTargetSelectorType =
                targetSelectorHelperService.getClass().getAnnotation(SupportTargetSelectorType.class);
